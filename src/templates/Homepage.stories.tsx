    ...
    <>
      ...
      <Main>
        <FullBanner
          ...
          maxWidth="alignfull"
          media={
            <FullBanner.Video src="https://cdn.carleton.ca/truth/videos/discover-20260513140912.webm" />
          }
          opacity={0}
        >
          <ButtonGroup>
            <Button title="Explore Our Programs" />
            <Button color="white" title="Virtual Tour" />
          </ButtonGroup>
        </FullBanner>
        ...
        <WideWave>
          ...
          <Column cols="2" maxWidth="alignwide">
            <Column.Content>
              ...
              <ButtonGroup>
                <Button color="red" title="Read more" />
              </ButtonGroup>
            </Column.Content>
            <Column.Content>
              <Figure align="none" size="full">
                <img
        ...
        <ImageCover image="tory" contentWidth="alignwide">
          <PageHeader as="h2" header="Attend Carleton" size="lg" />
          <Column cols="4" maxWidth="alignwide">
        ...
        <Section maxWidth="alignwide" contentWidth="alignwide">
          <PageHeader as="h2" header="Campus Life" size="lg" />
          <ImageGrid cols="3" gap="sm" maxWidth="alignwide">
            <ImageGrid.Image
              imageUrl={ImageData[2].image}
              colSpan="2"
              rowSpan="2"
            ...
            />
            {ImageData.slice(3, 5).map(({ id, image }: { id: number; image: string }) => (
        ...
        <WideWave>
          ...
          <Column cols="2" maxWidth="alignwide">
            ...
            <Column.Content>
              <MultiParagraph count={1} />
              <ButtonGroup>
                <Button color="red" title="Get Tickets" />
              </ButtonGroup>
            </Column.Content>
          </Column>
        </WideWave>
        ...
        <Section bgType="grey" maxWidth="alignfull" contentWidth="alignwide">
          <PageHeader as="h2" header="Upcoming Events" size="lg" />
          <Column cols="4" maxWidth="alignwide">
