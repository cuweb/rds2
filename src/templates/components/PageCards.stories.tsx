...
export const PageCardComponent: Story = {
    name: 'Page Cards',
    parameters: {
        a11y: {
            config: {
    ...
    render: () => (
        <>
            ...
            <Main>
                ...
                <Column cols="3">
                    {PageData.slice(0, 6).map(item => <Card key={`page-${item.id}`}>
                        <Card.Header title={item.title} link={item.link} date={item.date} datePrefix="Modified on " position="bottom" />
                        <Card.Body>
                ...
                <Column cols="4" maxWidth="alignwide">
                    {PageData.slice(0, 8).map(item => <Card key={`page-${item.id}`}>
                        <Card.Header title={item.title} link={item.link} date={item.date} datePrefix="Modified on " position="bottom" />
                        <Card.Body>
                            <Card.Excerpt text={item.excerpt} />
                        </Card.Body>
