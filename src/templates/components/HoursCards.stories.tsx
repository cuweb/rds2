...
import { formatHoursStatus } from '../../components/Status/hoursStatus';
...
export const HoursCardComponent: Story = {
    name: 'Hours Cards',
    parameters: {
        a11y: {
            config: {
        ...
        <>
            ...
            <Main>
                ...
                <Section as="section" maxWidth="alignwide" bgType="grey">
                    ...
                    <Column cols="3">
                        {HoursData.slice(0, 6).map((item) => {
                            const { variant, label } = formatHoursStatus(
                                item.openTime,
                                item.closeTime,
                            );
                            return (
