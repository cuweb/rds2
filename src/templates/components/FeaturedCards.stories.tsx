...
export const FeaturedCardComponent: Story = {
    name: 'Featured Cards',
    parameters: {
        a11y: {
            config: {
        ...
        <>
            ...
            <Main>
                <Section maxWidth='alignfull' bgType="light-gradient" isHero>
                    <PageHeader
                        as="h1"
                        header="Featured Card Component"
                ...
                <Column cols="3">
                    {NewsData.slice(0, 6).map(item => <Card key={`news-${item.id}`}>
                        <Card.Figure isSmall>
                ...
                <Column cols="4" maxWidth="alignwide">
                    {NewsData.slice(0, 8).map(item => <Card key={`news-${item.id}`}>
                        <Card.Figure isSmall>
                            <img src={item.image} alt={item.alt} width="600" height="400" />
                        </Card.Figure>
                        <Card.Header title={item.title} link={item.link} />
