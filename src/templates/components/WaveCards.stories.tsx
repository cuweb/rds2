    ...
    render: () => (
        <>
            ...
            <Main>
                ...
                <Column cols="3">
                    {LanguageData.slice(0, 6).map(item => <Card key={`language-${item.id}`} isGrey hasWave>
                        <Card.Header title={item.title} link={item.link} date={item.date} datePrefix="Released on " position="bottom" />
                        <Card.Body>
                ...
                <Column cols="4" maxWidth="alignwide">
                    {LanguageData.slice(0, 8).map(item => <Card key={`language-${item.id}`} isGrey hasWave>
                        <Card.Header title={item.title} link={item.link} date={item.date} datePrefix="Released on " position="bottom" />
                        <Card.Body>
                            <Card.Excerpt text={item.excerpt} />
                        </Card.Body>
