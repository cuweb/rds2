...
export const StatCardComponent: Story = {
    name: 'Stat Cards',
    parameters: {
        a11y: {
            config: {
    ...
    render: () => (
        <>
            ...
            <Main>
                ...
                <Column cols="3">
                    {StatData.slice(0, 6).map(item => <Card key={`stat-${item.id}`} leftBorder>
                ...
                <Column cols="4" maxWidth="alignwide">
                    {StatData.slice(0, 8).map(item => <Card key={`stat-${item.id}`} leftBorder>
                        <Card.Stats stat={item.stat} desc={item.desc} reverse />
                    </Card>)}
                </Column>
