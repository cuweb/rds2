...
export const IconCardComponent: Story = {
    name: 'Icon Cards',
    parameters: {
        a11y: {
            config: {
    ...
    render: () => (
        <>
            ...
            <Main>
                ...
                <Column cols="3">
                    {IconData.slice(0, 6).map(item => <Card key={`icon-${item.id}`}>
                        <Card.Figure isIcon>
                ...
                <Column cols="4" maxWidth="alignwide">
                    {IconData.slice(0, 8).map(item => <Card key={`icon-${item.id}`}>
                        <Card.Figure isIcon>
                            <Icon name={item.icon} size={40} color="var(--rds--color-primary)" />
                        </Card.Figure>
                        <Card.Header title={item.title} link={item.link} />
