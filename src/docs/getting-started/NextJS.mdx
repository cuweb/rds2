...
Your Vercel / GitHub Actions / other deploy pipeline needs GitHub Packages auth too. Set up `NODE_AUTH_TOKEN` with a GitHub Packages token in your CI environment.
